...
import '../../data/model/categories/categories_request.dart';
import '../../data/model/categories/categories_response.dart';
import '../flutter_flow/flutter_flow_theme.dart';

class RiskAreaCategoryDetailedListView extends StatefulWidget {
  final RiskAreaDetailedViewArguments riskAreaCategoryDetailedViewArguments;
  const RiskAreaCategoryDetailedListView(
      {Key? key, required this.riskAreaCategoryDetailedViewArguments})
      : super(key: key);

  @override
  State<RiskAreaCategoryDetailedListView> createState() =>
      _RiskAreaCategoryDetailedListViewState();
}

class _RiskAreaCategoryDetailedListViewState
    extends State<RiskAreaCategoryDetailedListView> {
  ...
  void initState() {
    ...
    masterBloc.categoriesRequest(CategoriesRequest(
        query: widget.riskAreaCategoryDetailedViewArguments.riskAreaCategoryId
            .toString(),
        pageNo: "1"));
    super.initState();
  }
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              widget.riskAreaCategoryDetailedViewArguments
