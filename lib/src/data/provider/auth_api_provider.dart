...
import '../model/cart/add_to_cart_response.dart';
...
class AuthApiProvider {
  ...
  Future<StateModel> createAccountWithPhoneNo(request) async {
    final response = await ObjectFactory().apiClient.createAccountWithPhoneNo(request);
    ...
    if (response.statusCode == 200) {
      ...
      return StateModel<AuthUserResponse>.success(AuthUserResponse.fromJson(response.data));
    } else
    {
