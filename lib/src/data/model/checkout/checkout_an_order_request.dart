...
//
//     final checkoutAnOrderRequest = checkoutAnOrderRequestFromJson(jsonString);

import 'dart:convert';

CheckoutAnOrderRequest checkoutAnOrderRequestFromJson(String str) =>
    CheckoutAnOrderRequest.fromJson(json.decode(str));

String checkoutAnOrderRequestToJson(CheckoutAnOrderRequest data) =>
    json.encode(data.toJson());

class CheckoutAnOrderRequest {
  CheckoutAnOrderRequest({
    required this.userPayLoad,
  });

  final UserPayLoad? userPayLoad;

  factory CheckoutAnOrderRequest.fromJson(Map<String, dynamic> json) =>
      CheckoutAnOrderRequest(
...
class CouponCodes {
  ...
  factory CouponCodes.fromJson(Map<String, dynamic> json) => CouponCodes(
